export const registryConfig = {
   ...
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@paranjay",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://paranjay.dev/r/{name}.json" resolves to "https://paranjay.dev/r/wheel-picker.json"
  ...
  namespaceUrl:
    ...
    "https://paranjay.dev/r/{name}.json",
}
